...
from keras.layers import Input, Dense, Activation, Conv2D, ELU, TimeDistributed, Flatten, Dropout, Lambda
...
def speed_model():
    ...
    adam = Nadam(learning_rate=0.001, beta_1=0.99, beta_2=0.999)  #Nadam()
...
def nvidia_model():
    ...
    adam = Nadam(learning_rate=0.002, beta_1=0.9, beta_2=0.999)  #Nadam()
    model.compile(optimizer=adam, loss='mse')
